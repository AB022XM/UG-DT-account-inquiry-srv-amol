...
To build the final jar and optimize the AccountInquirySrvviaAmol application for production, run:
...
Then navigate to [http://localhost:9025](http://localhost:9025) in your browser.
