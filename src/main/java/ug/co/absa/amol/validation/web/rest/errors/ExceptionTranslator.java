package ug.co.absa.amol.validation.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.amol.validation.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.amol.validation.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.amol.validation.service.InvalidPasswordException
